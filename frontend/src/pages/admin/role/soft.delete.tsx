...
import { callDeleteRole, callFetchPermission, callFetchRoleDeleted } from "@/config/api";
...
const RoleDeleted = () => {
    ...
    useEffect(() => {
        const init = async () => {
            const res = await callFetchRoleDeleted(`page=1&size=100`);
            if (res.data?.result) {
